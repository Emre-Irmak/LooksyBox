-- Beğeni sistemi için SQL fonksiyonları
-- Bu dosyayı Supabase SQL Editor'da çalıştırın

-- 1. Beğeni ekleme fonksiyonu
...
-- 4. Ürün beğeni durumunu toggle etme fonksiyonu
...
-- Örnek kullanım:
-- SELECT add_product_like('user-uuid-here', 1);
-- SELECT remove_product_like('user-uuid-here', 1);
-- SELECT toggle_product_like('user-uuid-here', 1);
-- SELECT check_user_like('user-uuid-here', 1);
